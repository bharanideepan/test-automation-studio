        ...
        <>
            ...
            {list.length > 0 && (
                ...
                >
                    ...
                    <Grid item xs={6} classes={{ item: classes.item }} py={2}>
                        {/* <SelectorListView testSuite={selectedtestSuite} selectors={list.find((testSuite: testSuite) => testSuite.id == selectedtestSuite?.id)?.selectors} selectedSelector={selectedSelector} setSelectedSelector={setSelectedSelector} /> */}
                    </Grid>
                </Grid>
            )}
        </>
